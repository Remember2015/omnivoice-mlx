...
from .dac import AcousticDecoder, AcousticEncoder, ResidualVectorQuantizer  # vendored
...
def _sinc_resample(
    ...
    t_pi = t * np.pi
    with np.errstate(invalid="ignore", divide="ignore"):  # vendored: t_pi == 0 handled by where
...
class HiggsAudioTokenizer(nn.Module):
    ...
    def _init_encode_modules(self):
        from .wav2vec import ModelConfig, Wav2Vec2Model  # vendored: local copy
