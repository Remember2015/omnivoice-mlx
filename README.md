...
| | RTF（7–34 字合并） | 46 s 段落 | 首包 = 整句 |
|---|---:|---:|---|
| 官方 torch CPU fp32，32 步 | ≈2–3 | — | — |
| 官方 torch MPS fp32 / fp16，32 步 | 0.98 / 1.14 | — | — |
| 本移植 fp16，32 步 | 0.23 | 0.10 | 0.5–1.0 s |
| **本移植 8-bit+fp16，16 步 + kv8 + ue3（默认）** | **0.106** | ≈0.08 | **0.23–0.44 s** |
| 同上 8 步 + kv4（快档，UTMOS −5 %） | 0.075 | 0.057 | 0.16–0.32 s |
| 同上，多句按长度分桶 B=4–8（吞吐） | 0.080 | — | — |
