...
| 来源 | 框架 | 设备 | 权重 | 激活 | 步数 | RTF 短句 | RTF 长段 | 整句延迟 | 备注 |
|---|---|---|---|---|---:|---:|---:|---:|---|
| 官方 | torch | CPU | fp32 | fp32 | 32 | ≈2–3 | — | — | |
| 官方 | torch | MPS | fp32 | fp32 | 32 | 0.98 | — | — | |
| mlx-audio | MLX | GPU | bf16 | bf16 | 32 | 0.68 | — | — | |
| 本项目 | MLX | GPU | 8-bit | fp16 | 32 | 0.381 | 0.25 | 0.5–1.0 s | |
| **本项目** | **MLX** | **GPU** | **8-bit** | **fp16** | **16** | **0.106** | **≈0.08** | **0.23–0.44 s** | **默认** |
| 本项目 | MLX | GPU | 8-bit | fp16 | 16 | 0.080 | — | — | batch B=4–8 |
